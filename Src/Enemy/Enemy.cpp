...
void StepEnemy()
{
	...
	case 12:
		...
		g_EnemyData.pos.x = g_EnemyData.pos.x - 10;
...
void DrawEnemy()
{
	...
	int animEnemyBulletID = g_EnemyData.m_dir * ENEMY_GRAPH_X + animNum[g_EnemyData.animCnt / ANIM_ENEMY_BULLET_COUNT];
